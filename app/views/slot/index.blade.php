                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-7 ml-auto">
                        <ul class="fillter">
                            ...
                            <li class="d-inline-block"><a href="{{ url('/slotdetails') }}"><input class="bg_none" type="button" value="clear"></a></li>
                            ...
                            <li class="fillter_icon d-inline-block"><a href="javascript:void(0)" class="filter_pop"> {{ HTML::image("public/listingimg/fillter.png") }}</a>
                                ...
                                <div class="filtter_option">
                                    ...
                                    <div class="form-group">
                                        <a href="{{ url('/slotdetails') }}"><button type="button" id="btn" class="btn btn-primary border-0">Clear</button></a>
                        ...
                        <ul class="fillter">
                            ...
                            <li class="fillter_icon d-inline-block"><a href="javascript:void(0)" class="filter_pop">{{ HTML::image("public/listingimg/fillter.png") }}</a>
                                <div class="filtter_option">
                                    ...
                                    <div class="form-group">
                                        <a href="{{ url('/slotdetails') }}"><button type="button" id="btn" class="btn btn-primary border-0">Clear</button></a>  <button type="submit" onClick="resfilter()" class="btn btn-primary border-0">Apply</button></div>
