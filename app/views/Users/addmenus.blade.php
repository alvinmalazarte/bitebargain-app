                ...
                <div class="informetion_top">
                    ...
                    <div class="pery">
                        ...
                        <div class="firest_row">
                            <div class="labelname">Spicy <span class="red-mark"> *</span></div>
                            <div class="week">
                        ...
                        <div class="firest_row">
                            <div class="labelname">Discounted <span class="red-mark"> *</span></div>
                            <div class="week">

                                <p class="field switch">
                                    <label class="cb-enable2 "><span>Yes</span></label>
                                    <label class="cb-disable2 selected"><span>No</span></label>
                                    {{ Form::checkbox('discounted', 0, FALSE, ['id' => 'checkbox2', 'class'=>'checkbox2']) }}
                                </p>
                                <div class="hint-onoff">
                                    If you choose yes than food is marked as a discounted and mentioned in the menu listing.
                                </div>
                            </div>
                        </div>
                        <div class="firest_row">
                            <div class="labelname">Visible <span class="red-mark"> *</span></div>
                            <div class="week">

                                <p class="field switch">
                                    <label class="cb-enable3 "><span>Yes</span></label>
                                    <label class="cb-disable3 selected"><span>No</span></label>
                                    {{ Form::checkbox('visible', 0, FALSE, ['id' => 'checkbox3', 'class'=>'checkbox3']) }}
                                </p>
                                <div class="hint-onoff">
                                    If you choose yes than food is marked as a visible and display in separate section called best deals.
                                </div>
                            </div>
                        </div>
                        <div class="firest_row">
                            <div class="labelname">Popular Item <span class="red-mark"> *</span></div>
                            <div class="week">

                                <p class="field switch">
                                    <label class="cb-enable3 "><span>Yes</span></label>
                                    <label class="cb-disable3 selected"><span>No</span></label>
                                    {{ Form::checkbox('popular', 0, FALSE, ['id' => 'checkbox3', 'class'=>'checkbox3']) }}
                                </p>
                                <div class="hint-onoff">
                                    If you choose yes than food is marked as a popular item and display in separate section called best deals.
                                </div>
                            </div>
                        </div>
                        ...
                        <!--                        <div class="form_group">
                                                    {{ HTML::decode(Form::label('modifiers', "Modifiers Prompt <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                                                    <div class="in_upt">
                        <?php
//                                $cuisine_array = array(
//                                    '' => 'Please Select'
...
//                                }
                        ?>
                                                        {{ Form::select('modifiers', $cuisine_array, Input::old("modifiers"), array('class' => 'form-control required', 'id'=>'modifiers','multiple'=>'multiple')) }}
                                                    </div>
                                                </div>-->
                        <div class="form_group">    
                        ...
                        <!--                        <div class="form_group">
                                                    {{ HTML::decode(Form::label('name', "Name ",array('class'=>"control-label col-lg-2"))) }}
                                                    <div class="in_upt">
                                                        {{  Form::text('name[]', '',  array('class' => 'form-control','id'=>"name"))}}
                                                    </div>
                                                </div>
                                                <div class="form_group">
                                                    {{ HTML::decode(Form::label('qty', "Quantity ",array('class'=>"control-label col-lg-2"))) }}
                                                    <div class="in_upt">
                                                        {{  Form::text('qty[]', '',  array('class' => 'positiveNumber number form-control','id'=>"qty"))}}
                                                    </div>
                        ...
                        <?php
//                        if (isset($cuisineData) && empty($cuisineData->discount)) {
                        ?>
                        <div class="form_group">
                            {{ HTML::decode(Form::label('discount', "Discount(%) <span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                            <div class="in_upt">
                                {{  Form::text('discount', Input::old("discount"),  array('class' => 'required positiveNumber number form-control','id'=>"discount"))}}
