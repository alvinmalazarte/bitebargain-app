        ...
        <div class="right_wrap_inner">
            ...
            <div class="informetion informetion_new">
                <div class="informetion_top">
                    <div class="tatils"> <span class="personal">Change Picture</span></div>
                    <div class="pery">
                                ...
                                <div class="in_upt">
                                    <div class="in_upt_img">
                                        <?php if (file_exists(UPLOAD_FULL_PROFILE_IMAGE_PATH . '/' . $userData->profile_image) && $userData->profile_image != "") { ?>
                                            ...
                                            <div class="showchange"><a href="javascript:void();" onclick="checkDelete();"><i class="fa fa-trash-o" aria-hidden="true"></i></a></div>
                                            <?php
                                        } else {
                        ...
                        <div class="form_group">
                            ...
                            <div class="in_upt in_upt_res spacew">
                                ...
                                {{ Form::submit('Save', array('class' => "btn btn-primary",'onclick' => 'return imageValidation();')) }}
                            </div>
                        </div>
                    </div>
                </div>
