        ...
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        {{ html_entity_decode(HTML::link(HTTP_PATH.'admin/restaurants/admin_index', '<i class="fa fa-cutlery"></i> Restaurants' , array('id' => ''), true)) }}
                    </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/restaurants/Admin_menulist/'.$usersdata->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
