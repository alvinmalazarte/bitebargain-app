            ...
            foreach ($records as $order) {
                ...
                <div class="menu_block <?php echo $class . ' ' . $color; ?>  order_box">
                    <div class="menu_top_title">
                        <span class="pull-left"><?php echo $order->first_name; ?> <?php echo substr($order->last_name, 0, 1); ?>. </span> <?php if ($order->reservation_status == 'Pending') { ?><a class="circle_btn" href="#">New</a><?php } ?>
                    ...
                    <div class="simple_btn ">
                        ...
                        <a class="simple_btn_menu detail_reser" data-id="<?php echo $order->id; ?>" data-order="<?php echo $order->id; ?>" href="javascript:void(0);" data-toggle="modal" data-target="#editresModal<?php echo $order->id; ?>">details</a>
...
<div class="tab_bottom fivetab six_tab">
    <ul>
        <li class="active">
