...
//print_r($cartItems);
            ...
            <div class="menu_block <?php echo $class . ' ' . $color; ?>  order_box">
                ...
                <div class="simple_btn ">
                    ...
                    <a class="simple_btn_menu detail_ord" data-id="<?php echo $order->id; ?>" data-order="<?php echo $order->slug; ?>" href="javascript:void(0)" data-keyboard="true" data-backdrop="true" data-controls-modal="leave_modal" data-toggle="modal" data-target="#editreserModal_<?php echo $order->id; ?>">details</a>
