        ...
        <div class="right_wrap_inner">
            <div class="informetion informetion_new">
                ...
                <div class="informetion_top">
                    <div class="tatils"> <span class="personal"> Reservations History</span></div>

                    <div class="tabel_option">
                        <ul class="tabel_option_li">
                            <li class="{{Request::is('reservation/receivedorders/all') ? 'active' :''}}"><a href="{{HTTP_PATH.'reservation/receivedorders/all'}}">ALL ({{$all_query ? count($all_query) :'0'}})</a></li>
                            <li class="{{Request::is('reservation/receivedorders/new') ? 'active' :''}}"><a href="{{HTTP_PATH.'reservation/receivedorders/new'}}">NEW ({{$pending_query ? count($pending_query):'0'}})</a></li>
                            <li class="{{Request::is('reservation/receivedorders/confirm') ? 'active' :''}}"><a href="{{HTTP_PATH.'reservation/receivedorders/confirm'}}">CONFIRMED ({{$confirm_query ? count($confirm_query) :'0'}})</a></li>
                            <li class="{{Request::is('reservation/receivedorders/noshow') ? 'active' :''}}"><a href="{{HTTP_PATH.'reservation/receivedorders/noshow'}}">No Show ({{$noshow_query ? count($noshow_query) :'0'}})</a></li>
                            <li class="{{Request::is('reservation/receivedorders/cancel') ? 'active' :''}}"><a href="{{HTTP_PATH.'reservation/receivedorders/cancel'}}">CANCELLED ({{$cancel_query ? count($cancel_query):'0'}})</a></li>
                        </ul>  
                    </div>
                                                    ...
                                                    <div class="wrapper_login">
                                                        ...
                                                        <div class="order_pop i_trab">
                                                            ...
                                                            <div class="subtotlall"><div class="left_totla"> Status</div> 
                                                                ...
                                                                <div class="right_totla dropp_half ">{{ Form::select('status', $status_array,$data->reservation_status, array('class' => 'form-control status'.$data->id, 'id'=>'city')) }}</div>
                                                            </div>
...
<script>
    ...
    url: "<?php echo HTTP_PATH . "reservation/updatestatus" ?>",
            ...
            success: function (data, textStatus, XMLHttpRequest)
            {
                alert("Reservation data updated success!");
            }
    });
    }
</script>
