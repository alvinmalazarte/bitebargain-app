    ...
    b.fn.uploadFile=function(t){
        ...
        function f(w,u,v){
            ...
            v.on("drop",function(x){
                ...
                if(!u.multiple&&s.length>1){
                    if(u.showError){
                        b("<div style='color: red; margin-top: 11px; margin-bottom: 12px;'>"+u.multiDragErrorStr+"</div>").appendTo(w.errorLog)
                    }
                    return
                }
        ...
        function l(H,B,u){
            for(var C=0;C<u.length;C++){
                if(!c(B,H,u[C].name)){
                    if(H.showError){
                        b("<div style='color: red; margin-top: 11px; margin-bottom: 12px;'><b>"+u[C].name+"</b> "+H.extErrorStr+H.allowedTypes+"</div>").appendTo(B.errorLog)
                    }
                    continue
                }
                if(H.maxFileSize!=-1&&u[C].size>H.maxFileSize){
                    if(H.showError){
                        b("<div style='color: red; margin-top: 11px; margin-bottom: 12px;'><b>"+u[C].name+"</b> "+H.sizeErrorStr+i(H.maxFileSize)+"</div>").appendTo(B.errorLog)
                    }
                    continue
                }
                if(H.maxFileCount!=-1&&B.selectedFiles>=H.maxFileCount){
                    if(H.showError){
                        b("<div style='color: red; margin-top: 11px; margin-bottom: 12px;'><b>"+u[C].name+"</b> "+H.maxFileCountErrorStr+H.maxFileCount+"</div>").appendTo(B.errorLog)
                    }
                    continue
                }
                B.selectedFiles++;
        ...
        function q(y,B,D,u){
            ...
            z.change(function(){
                ...
                if(this.files){
                    ...
                    if(!c(y,D,I)){
                        if(D.showError){
                            b("<div style='color: red; margin-top: 11px; margin-bottom: 12px;'><b>"+I+"</b> "+D.extErrorStr+D.allowedTypes+"</div>").appendTo(y.errorLog)
                        }
                        return
                    }
                    F.push({
                ...
                if(a.fileapi&&a.formdata){
                    ...
                    if(D.maxFileCount!=-1&&(y.selectedFiles+G.length)>D.maxFileCount){
                        if(D.showError){
                            b("<div style='color: red; margin-top: 11px; margin-bottom: 12px;'><b>"+E+"</b> "+D.maxFileCountErrorStr+D.maxFileCount+"</div>").appendTo(y.errorLog)
                        }
                        return
                    }
        ...
        function n(z,y,u,w,A){
            ...
            var v={
                ...
                beforeSubmit:function(F,C,E){
                    ...
                    u.statusbar.append("<div style='color: red; margin-top: 11px; margin-bottom: 12px;'>"+y.uploadErrorStr+"</div>");
                    u.cancel.show();
                    z.remove();
                ...
                error:function(C,s,B){
                    ...
                    if(C.statusText=="abort"){
                        ...
                        if(y.showStatusAfterError){
                            u.progressDiv.hide();
                            u.statusbar.append("<span style='color: red; margin-top: 11px; margin-bottom: 12px;'>ERROR: "+B+"</span>")
                        }else{
                            u.statusbar.hide();
                            u.statusbar.remove()
                        }
